...
const Header = () => {
  ...
  <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                ...
                <div className="dropdown-menu"  style={{position: 'absolute',right: 0,top: 35,padding: '25px 15px',width: '350px'}} aria-labelledby="dropDownMenuButtonTwo">
                  ...
                  <div className="w-100">
                  <p>Cart total: <span className="order-summary-values">${cartItems.reduce((acc, item)=> (acc + item.quantity * item.price), 0).toFixed(2)}</span></p>
                  <Link to={'/cart'} className="btn btn-warning w-100">Go to Cart</Link>
                  </div>
                  </div> 
          </div> 
