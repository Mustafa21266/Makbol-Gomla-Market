...
const domainList = [
  ...
  const readNotificationHandler = (id) => {
    document.getElementById('parent2').className = "dropdown-menu dropdown-menu-left animate__animated animate__fadeIn"
          ...
          <div className="dropdown dropleft d-inline"> 
                ...
                <div id="parent1" className="dropdown-menu dropdown-menu-left animate__animated animate__fadeIn"  style={{position: 'absolute',right: 0,top: 35,padding: '15px 0px'}} aria-labelledby="dropDownMenuButton">
                  {user && (user.role === 'admin' || user.role === 'seller') && (
                    <div>
                    <Link onClick={(e) => document.getElementById('parent1').className = "dropdown-menu dropdown-menu-left animate__animated animate__fadeIn" } to={user.role === "admin" ? "/dashboard" : "/seller/dashboard"} className="dropdown-item text-center">لوحة التحكم</Link>
                    <hr />
                    </div>
                    
                  )}
                <Link to="/orders/me"  onClick={(e) => document.getElementById('parent1').className = "dropdown-menu dropdown-menu-left animate__animated animate__fadeIn" } className="dropdown-item text-center">الأوردرات</Link>
                <hr />
                <Link to="/me"  onClick={(e) => document.getElementById('parent1').className = "dropdown-menu dropdown-menu-left animate__animated animate__fadeIn" } className="dropdown-item text-center">حسابي</Link>
                <hr />
                ...
                <div id="parent3" className="dropdown-menu drop-carta dropdown-menu-left animate__animated animate__fadeIn"  style={{position: 'absolute', right: -120 ,top: 35,padding: '25px 15px',width: '350px'}} aria-labelledby="dropDownMenuButtonTwo">
                  {cartItems && cartItems.map(item => (
                    <Fragment key={item._id}>
                      <Link  onClick={(e) => document.getElementById('parent3').className = "dropdown-menu dropdown-menu-left animate__animated animate__fadeIn" }  to={`/product/${item.product}`} className="dropdown-item">
                  ...
                  <Link onClick={(e) => document.getElementById('parent1').className = "dropdown-menu dropdown-menu-left animate__animated animate__fadeIn" } to={'/cart'} className="btn w-100"  style={{backgroundColor:'#178a53', color:"white"}} >إذهب إلى سلة التسوق</Link>
                  </div>
                  </div> 
          </div> 
</div>
