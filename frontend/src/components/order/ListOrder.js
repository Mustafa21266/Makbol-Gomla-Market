    ...
    const setOrders = () => {
        ...
        orders && orders.forEach(order => {
            data.rows = data.rows.concat ({
                ...
                status: order.orderStatus && String(order.orderStatus).includes('Delivered') ? <p style={{color: 'green'}}>تم التوصيل</p> : String(order.orderStatus).includes('Delivered') ? <p style={{color: 'red'}}>تحت التأكيد</p> : String(order.orderStatus).includes('Shipped') ? <p style={{color: 'red'}}>جاري التوصيل</p> : '',
