...
export const createAccounting = (accounting) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(`http://localhost:8000/api/v1/accounting/new`, accounting,config)
        dispatch({
...
export const updateAccounting = (id, accountingData) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(`http://localhost:8000/api/v1/admin/accounting/${id}`, accountingData,config)
        dispatch({
...
export const deleteAccounting = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.delete(`http://localhost:8000/api/v1/admin/accounting/${id}`)
        dispatch({
...
export const myAccountings = () => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(`http://localhost:8000/api/v1/accountings/me`)
        dispatch({
...
export const allAccountings = () => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(`http://localhost:8000/api/v1/admin/accountings`)
        dispatch({
...
export const getAccountingDetails = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(`http://localhost:8000/api/v1/accounting/${id}`)
        dispatch({
